"""
core/knowledge/fetchers/extreme_fetcher.py
=============================================
Extreme Networks EXOS / VOSS documentation fetcher — same search-first
pattern as fortinet_fetcher.py.
"""
...
logger = logging.getLogger("AI Net Studio.Knowledge.ExtremeFetcher")


class ExtremeFetcher(VendorFetcher):
    """Extreme Networks EXOS / VOSS documentation fetcher."""
    ...
    def parse_page(
        ...
        version_match = re.search(r"EXOS\s+\d+(?:\.\d+)*", soup.get_text())
